...
struct Constants {
    ...
    struct Additional {
        static let appGroupID = "group.com.acapplications.studyai" // Replace with your App Group ID
        
        static let coreDataModelName = "ChitChat"
        
        static let freeResponseCharacterLimit: Int = 250
    }
...
//    static let reviewFrequency = 7
    static let adFrequency = 3
    static let premiumFrequency = 12
...
//    static let monthlyProductIdentifier = "ultramonthly"
    ...
    static let copyFooterText = "Made on Assistants - Pro AI Chatbots!"//Smart AI Companions!" // TODO: Change this around lol
    ...
    struct Migration {
        ...
        static let userDefaultStoredV5_7MigrationComplete = "v5_7MigrationComplete"
    }
            ...
            struct Table {
                struct Cell {
                    struct UltraPurchase {
                        ...
                        static let defaultTitleText = "Tap to Claim 7 Days Free"
...
//            static let sparkleLightElementTextColor = "sparkleLightElementTextColor"
        ...
        struct CaptureIcons {
            ...
            static let economics = "Economics"
        }
        ...
        static let cameraButtonCreateChat = "cameraButtonCreateChat"
        ...
        static let blurryNavBarBackground = "Blurry Nav Bar Background"
    ...
    struct UserDefaults {
        ...
        static let constantsSetupCompleteLatestVersion = "constantsSetupCompleteLatestVersion"
        
        static let deviceAssistantsVersion = "deviceAssistantsVersion"
        
        static let googleSearchDisabled = "googleSearchDisabled"
        
        static let liveSpeechSilenceDuration = "liveSpeechSilenceDuration"
        static let liveSpeechSpeed = "liveSpeechSpeed"
        static let liveSpeechVoice = "liveSpeechVoice"
        
        static let pastChatStorageUserDefaultKey = "pastChatStorageUserDefaultKey"
        
        static let hapticsDisabled = "hapticsDisabled"
        
        static let notFirstLaunchEver = "notFirstLaunchEver"
        
        static let resumeConversationOnLaunch = "resumeConversationOnLaunch"
        ...
        static let userDefaultStoredActiveAssistant = "activeAssistant"
        static let userDefaultStoredFaceAssistantID = "faceAssistantID"
        ...
        static let wormSetAsPrimaryAssistantForPreviousNonWormUsers = "wormSetAsPrimaryAssistantForPreviousNonWormUsers"
    }
}
...
struct HTTPSConstants {
    ...
    struct StructuredOutput {
        ...
        static let generateFlashCards = "/generateFlashCards"
    ...
    static let chitChatServerStructuredOutputPath = "/structuredOutput"
    
    static let checkIfChatRequestsImageRevision = "/checkIfChatRequestsImageRevision"
    static let deleteChat = "/deleteChat"
    static let generateDrawers = "/generateDrawers"
    static let generateGoogleQuery = "/generateGoogleQuery"
    static let generateImage = "/generateImage"
    static let generateSpeech = "/generateSpeech"
    static let generateTitle = "/generateTitle"
    ...
    static let printToConsole = "/printToConsole"
...
//    static let getGenerateImage = "/getImageUrlFromGenerateUrl"
    ...
    static let airtable = "https://api.airtable.com/v0"
    static let airtableListRecords = "/listRecords"
}
...
struct WebSocketConstants {
    ...
    static let getChatStream = "/streamChatDirect"
