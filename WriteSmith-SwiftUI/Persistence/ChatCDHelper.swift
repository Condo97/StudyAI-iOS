...
class ChatCDHelper {
    ...
    static func appendChat(sender: Sender, text: String?, flashCardCollection: FlashCardCollection? = nil, to conversation: Conversation, in managedContext: NSManagedObjectContext) async throws -> Chat {
        try await managedContext.perform {
            ...
            chat.text = text
            chat.date = date
            chat.flashCardCollection = flashCardCollection
...
//    static func appendChat(sender: Sender, text: String?, drawerCollection: GeneratedDrawerCollection, to conversation: Conversation, in managedContext: NSManagedObjectContext) async throws -> Chat {
//        try await managedContext.perform {
//            // Create Chat in managedContext
//            let chat = Chat(context: managedContext)
//            
...
//            chat.date = date
//            chat.conversation = conversation
//            chat.drawerCollection = drawerCollection
//            
//            // Update conversation latestChatDate and latestChatText TODO: Is this appropriate to do here? I guess this is the best place lol
//            conversation.latestChatDate = date
//            conversation.latestChatText = text
...
//    }
//    
//    static func appendChat(sender: Sender, text: String?, panelContent: PanelContent, to conversation: Conversation, in managedContext: NSManagedObjectContext) async throws -> Chat {
//        try await managedContext.perform {
//            // Create Chat in managedContext
//            let chat = Chat(context: managedContext)
//            
...
//            chat.date = date
//            chat.conversation = conversation
//            chat.panelContent = panelContent
//            
//            // Update conversation latestChatDate and latestChatText TODO: Is this appropriate to do here? I guess this is the best place lol
//            conversation.latestChatDate = date
//            conversation.latestChatText = text
...
//    }
    ...
    static func updateChat(chat: Chat, text: String, in managedContext: NSManagedObjectContext) async throws {
        try await managedContext.perform {
            chat.text = text
...
//    static func updateChat(chat: Chat, drawerCollection: GeneratedDrawerCollection, in managedContext: NSManagedObjectContext) async throws {
//        try await managedContext.perform {
//            chat.drawerCollection = drawerCollection
//            
//            try managedContext.save()
