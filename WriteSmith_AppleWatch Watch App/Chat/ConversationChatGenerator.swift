//
//  ConversationChatGenerator_Legacy.swift
//  WriteSmith-SwiftUI
//
...
//    }
    ...
    func generateChat(input: String, conversation: Conversation, authToken: String, isPremium: Bool, remainingUpdater: RemainingUpdater, in managedContext: NSManagedObjectContext) async throws {
        ...
        do {
            ...
            // TODO: Handle errors
            print("Error saving userChat to CoreData in ConversationChatGenerator_Legacy... \(error)")
//                throw ChatGeneratorError.addUserChat
        ...
        do {
            for try await message in stream {
                ...
                await MainActor.run { [fullOutput] in
                    ...
                    do {
                        ...
                        // TODO: Handle errors
                        print("Error saving to CoreData in ConversationChatGenerator_Legacy... \(error)")
                    }
                }
            ...
            // TODO: Handle errors
//            print("Error getting the next message in stream in ConversationChatGenerator_Legacy... \(error)")
        }
